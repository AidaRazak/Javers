...
2  | 1211103216           |  SOFEA HAZREENA BINTI HASDI    |Modified code to display the score board for each trick|     29%                 |
...
|            |      ||  ...                |
|            |      ||I...      |
3  |  1211103194| NUR FARAHIYA AIDA BINTI ABDUL RAZAK     | Implemented the logic to finish a round of the game correctly, including calculating and displaying the score of each player.   |29 %
