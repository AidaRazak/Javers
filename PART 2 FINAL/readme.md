...
-- | ---------- | ----                        | -----------------                                                        | :----------:
1  | 1211103123 |  AL ARSHAD BIN AL HANISHAM  |Recreated and reorganized the class files to implement better class design and data structures by creating the classes, Player, Game, Deck and Cards.                                      |28%
...
2  | 1211103216           |  SOFEA HAZREENA BINTI HASDI    |Modified the code to display the score board for each trick|     28%                 |
...
3  |  1211103194| NUR FARAHIYA AIDA BINTI ABDUL RAZAK     | Implemented the logic to restore the game state in GUI when resuming a game from a file or database.  |28 %
...
4  |   1211103373         |   MUHAMMAD ALIF BIN KHABALI   |Implemented the reset game functionality after first round is completed               | 16%
